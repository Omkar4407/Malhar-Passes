  ...
  return (
    <div style={{
      ...
      <div style={{ cursor: "pointer", display: "flex", flexDirection: "column" }} onClick={() => navigate("/")}>
        ...
        <p style={{ fontSize: "9px", color: "rgba(218, 184, 255, 0.5)", margin: 0, letterSpacing: "0.1em", textTransform: "uppercase", marginTop: "2px" }}>
          St. Xavier's College
        </p>
      </div>
          ...
          {isLoggedIn ? (
            ...
            <button
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = "0 1px 3px 1px rgba(60,64,67,0.15), 0 1px 2px 0 rgba(60,64,67,0.3)";
              }}
              onMouseLeave={e => {

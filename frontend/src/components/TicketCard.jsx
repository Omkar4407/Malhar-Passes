...
export default function TicketCard({ ticket }) {
  ...
  useEffect(() => {
    QRCode.toDataURL(JSON.stringify({ ticket_id: ticket.id }), { width: 200, margin: 2 })
      .then(setQr)
      ...
      <div style={styles.body}>
        <div style={styles.profileRow}>
          {ticket.photo_url ? (
            ...
            <div style={styles.photoPlaceholder}>{ticket.name?.[0]?.toUpperCase() || "?"}</div>
          )}
        ...
        <button type="button" onClick={() => setExpanded((v) => !v)} style={styles.qrToggle}>
          ...
          <div style={styles.qrSection}>
            {qrError ? (
              ...
              <>
                ...
                <a href={qr} download={`ticket-${ticket.id}.png`} style={styles.downloadBtn}>
                  ⬇ Download QR
                </a>
              </>
            ) : (

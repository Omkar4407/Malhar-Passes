...
export function parseCollegeDisplayFromBookingDetails(college: string | null | undefined): string | null {
...
export function normalizeCollegeDisplayName(name: string | null | undefined): string | null {
